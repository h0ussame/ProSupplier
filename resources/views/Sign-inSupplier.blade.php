...
<head>
    ...
    <link rel="stylesheet" href="stylesheet/AuthenSupplier.css" />
</head>
<body>
...
<div class="card mb-3">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="./images/de60104b9b32f119e575dce17d991675.jpg" class="img-fluid rounded-start" alt="">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h4 class="card-title">Hello Supplier !</h4>
        @if ($errors->any())
             <div class="alert alert-danger">
               {{$errors->first()}}
             </div>
        @endif
        <form id="myForm" class="row g-3" method="post" action="/createPendingSupplier">
          @csrf
          <div class="col-md-6">
          ...
          <label for="inputCategory" class="form-label">Category</label>
            <select id="inputCategory" class="form-select form-select-sm" name="category" required>
          ...
          <div class="col-md-8">
            ...
            <input type="text" class="form-control form-control-sm" id="inputCity" name="city" required>
          </div>
          <div class="col-md-4">
            <label for="inputZip" class="form-label">Zip Code</label>
            <input type="text" class="form-control form-control-sm" id="inputZip" placeholder="20000" name="zip_code" required>
          </div>
          {{-- <div class="col-md-4">
            <label for="inputState" class="form-label">State</label>
            <select id="inputState" class="form-select form-select-sm" name="state" >
          ...
          <div class="col-12">
            <button type="submit" class="btn btn-primary btn-sm " id="submitButton" name="submit" value="Supplier" disabled >Sign in</button>
          </div>
        </form>
      </div>
    </div>
